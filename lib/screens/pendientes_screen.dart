...
class PendientesTareasScreen extends StatefulWidget {
  const PendientesTareasScreen({Key? key}) : super(key: key);

  @override
  _PendientesTareasScreenState createState() => _PendientesTareasScreenState();
}
 ...
 late DatabaseHelper _databaseHelper;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar:  AppBar(
        backgroundColor: ColorSettings.colorButton2,
      ...
      body: FutureBuilder(
        future: _databaseHelper.getAllTareasPendientes(),
          ...
          return Card(
            child: Column(
              ...
              children : [
                ...
                Text(tarea.fechaEntrega!, style: TextStyle(fontWeight: FontWeight.normal, fontSize:10),),
                Row(
